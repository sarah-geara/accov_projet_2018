            ...
            if (ic.getCouleur()!=null){
                if(ic.getCouleur().equals(Couleur)){
                    ic.getWriter().println(Couleur);
                     ...
                     System.out.println("Mutation Complete New Color : "+ Couleur);
                      ic.setCouleur(null);
                waintingcount--;
                }
                  ...
                  ic.getWriter().println("Yellow");
                     icc.getWriter().println("Yellow");
                        System.out.println("Mutation Complete New Color : "+"Yellow");
                         ic.setCouleur(null);
                 waintingcount--;
            }
                  ...
                  ic.getWriter().println("Red");
                     ...
                     System.out.println("Mutation Complete New Color : "+"Red");
                      ic.setCouleur(null);
                 waintingcount--;
            }
                  ...
                  ic.getWriter().println("Blue");
                     ...
                     System.out.println("Mutation Complete New Color : "+"Blue");
                      ic.setCouleur(null);
                waintingcount--;
            }
